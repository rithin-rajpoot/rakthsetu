...
const UserProfile = () => {
  const {userProfile, userLocation, buttonLoading} = useSelector(state => state.userReducer);
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button 
                      ...
                      className="bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-xl font-semibold transition-all duration-200 flex items-center space-x-2"
                    >
                      {buttonLoading ? (
                        <>
